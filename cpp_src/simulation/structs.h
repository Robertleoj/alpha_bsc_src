...
struct EndgamePlayoutWeights {
    ...
    EndgamePlayoutWeights(double generation) {
        double uniform_at =config::hp["endgame_playout_uniform_generation"].get<double>();
        double uni_const =config::hp["endgame_playout_uniform_const"].get<double>();
        ...
        double p = std::pow((generation / uniform_at), power);
